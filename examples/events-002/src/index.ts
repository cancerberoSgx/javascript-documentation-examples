// # Documenting Events
// 
// IMO, the best way, unfortunately we need a typedoc plugin. 
// 
...
// 
// Since functions declarations don't generate any real js code, this won't impact the producction code generate at all
...
interface Vehicle extends EventEmitter {
  ...
  /** Subscribes to [[beforeStart]] event */
  on(eventName: 'afterStop', listener: typeof beforeStart): this;
