...
const config: { outputType: ('markdown' | 'docco'), language: string, linkPrefix:string } = {
...
const outputFile = config.outputType === 'docco' ? `${__dirname}${sep}index.ts` : `${__dirname}${sep}..${sep}docs${sep}tutorial.md`;
